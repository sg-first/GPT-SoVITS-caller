...
if __name__ == "__main__":
    ...
    audio_file_path = "E:/BaiduNetdiskDownload/Easy-Wav2Lip优化版-眠-0229/Easy-Wav2Lip-眠-0229/in/batman.wav"
    # 读取音频文件
    ...
    if duration_sec > 5:
        # 截取前三秒音频
        clipped_audio = audio[:5000]  # 3000毫秒 = 3秒

        # 定义新的文件路径
        audio_file_path = "clipped_audio.wav"

        # 保存剪辑后的音频到新文件
        clipped_audio.export(audio_file_path, format="wav")

    wav = handle(audio_file_path, "normal", "en", "Hello World I'm Batman. Today is really a good day because joker is gone", "en")
